...
for i in *bam do bam_stat.py -i $i > ~/project/bam_stat_results/bam_stat_${i%Aligned.sortedByCoord.out.bam}.txt samtools flagstat $i > ~/project/flagstat_results/flagstat_${i%Aligned.sortedByCoord.out.bam}.txt
